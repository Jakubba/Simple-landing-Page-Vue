<template>
  <header
    class="fixed top-0 z-50 flex items-center justify-between w-full p-6 bg-opacity-50 bg-gradient-to-t from-transparent to-black"
    data-aos="fade-down"
    data-aos-delay="1000"
  ...
  >
    ...
    <nav
      :class="[
        '-md:fixed inset-0 flex flex-col items-center justify-center bg-[#111827] md:bg-transparent md:justify-between md:flex-row md:block',
